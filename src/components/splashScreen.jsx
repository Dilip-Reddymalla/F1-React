...
export function SplashScreen() {
  const [isVisible, setIsVisible] = useState(() => {
    const hasSeenSplash = sessionStorage.getItem("f1_splash_seen");
  ...
  useEffect(() => {
    ...
    // Start fade out at 3.2s (text and car finish at 3.5s)
  ...
  if (!isVisible || isAnimationCompleted) return null;
    ...
    >
      ...
      <div className="splash-car-container">
        ...
        >
          ...
          <path
            d="M 28 115 L 72 115 L 78 165 L 62 195 L 38 195 L 22 165 Z"
            fill="#001a57"
          />

          {/* Red Bull branding swoosh patterns */}
          <path
            d="M 32 140 C 42 125 58 125 68 140 C 58 150 42 150 32 140"
            fill="#cc0000"
          />
